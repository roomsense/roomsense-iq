...
#define WIFI_AP_IP					"192.168.255.1"		// AP default IP
#define WIFI_AP_GATEWAY				"192.168.255.1"		// AP default Gateway (should be the same as the IP)
...
typedef enum wifi_app_message
{
	...
	WIFI_APP_MSG_REQUEST_STA_DISCONNECT_SWITCH,
	WIFI_APP_MSG_UPDATE_AP_KEY,
	WIFI_APP_MSG_UPDATE_AP_ENABLE,
} wifi_app_message_e;
